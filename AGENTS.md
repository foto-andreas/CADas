...
* Dreidimensionale DXF-Objekte mit ACIS-v1-`3DSOLID`-Körpern werden als skalierbare Objekt-Presets importiert, innen oder außen platziert und aus den entschlüsselten SAT-Randkurven als angenäherte Volumenkörper in 3D dargestellt.
